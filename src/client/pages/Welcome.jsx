  ...
  <div>
    <Helmet>
      <link
        rel="stylesheet"
        type="text/css"
        href="public/assets/pages/welcome/Welcome.bundle.css"
      />
    </Helmet>
    ...
    <div className={styles.pageContent}>
      <div className={styles.description}>
        ...
        <a className={styles.link} href="/">
          Grace Covenant Church (GCC)
        </a>
        {
          '! During your time with us, we hope you’ll be able to catch a glimpse of how God is faithfully moving in Philadelphia.'
        }
      </div>
      ...
      <div className={styles.description}>
        ...
        {'It isn’t our '}
        <a className={styles.link} href="/beliefs">
          beliefs
        </a>
        {
          '. We affirm the same basic Christian doctrines that have been a part of the Church for hundreds of years. Rather, we are committed to presenting these truths in a practical, relevant, contemporary, and loving manner. Our desire is to introduce you to Jesus Christ and to help you grow and become a kingdom worker.'
        }
      </div>

      <div className={styles.description}>
        <h4 className={styles.header}>How can you get involved?</h4>
        {'Our church is comprised of a network of '}
        <a className={styles.link} href="/familygroup">
          family groups
        </a>
        {
          ': small, intimate groups in which honest friendships, Bible study, prayer, and compassionate care for one another are emphasized. Our family groups are where the core of our evangelism and discipleship takes place. We invite you to join one and be able to call GCC your home!'
        }
        <br /> <br />
        {
      ...
      <div className={styles.maps}>
        <AspectRatio ratio={4 / 3}>
          <iframe
            frameBorder="0"
            title="Meyerson Hall"
            src={`https://www.google.com/maps/embed/v1/place?q=Meyerson+Hall,+Philadelphia,+PA,+United+States&key=${nconf.get('GOOGLE_MAPS_KEY')}`}
      ...
      <div className={styles.description}>
        ...
        <a className={styles.link} href="mailto:web@gracecovenant.net">
